...
int main(){
  ...
  if(access("C:/Users/CSE124/Desktop/small/5_2_0_13.jpg",R_OK) != -1){
    jpegFile = fopen("C:/Users/CSE124/Desktop/small/5_2_0_13.jpg", "r");
    logInfo("Opened ");
    fprintf(stdout, "%s\n","C:/Users/CSE124/Desktop/small/5_2_0_13.jpg");
    
    //Extract name of jpeg file
    char *ptr,*filename,c;
    int i;

    ptr = strrchr("C:/Users/CSE124/Desktop/small/5_2_0_13.jpg", '/'); // Find last slash in filename
    if(ptr) ptr++;         // First character of filename (path stripped)
    else    ptr = "C:/Users/CSE124/Desktop/small/5_2_0_13.jpg"; // No path; font in local dir.
