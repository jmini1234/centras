...
IMG_DIR = 'C:/Users/CSE_125-2/Desktop/data/'
...
for img in os.listdir(IMG_DIR):
        ...
        supervised=list()
        supervised.append(result[2][0])
        supervised.append(result[3][0])
        print(supervised)
        ...
        value = value.flatten()
        #print(len(value))
        with open('C:/Users/CSE_125-2/Desktop/output.csv', 'a', encoding="UTF-8", newline='') as f:
